...
interface ScanReceiptModalProps {
  isOpen: boolean;
  onClose: () => void;
  /** Called with extracted receipt data when confirmed */
  onReceiptScanned?: (receiptData: ReceiptData) => void;
  /** Backward-compat callback — called after confirmation with no arguments */
  onSuccess?: () => void;
}

export function ScanReceiptModal({ isOpen, onClose, onReceiptScanned, onSuccess }: ScanReceiptModalProps) {
              ...
              <div className="space-y-4">
                ...
                {previewUrl && (
                  <div className="space-y-3">
                    ...
                    <Button className="w-full gap-2" onClick={handleScanReceipt}>
          ...
          {scanStep === 'result' && scanResult && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button variant="outline" onClick={handleRetry} className="sm:flex-1 gap-2">
                  <RotateCw className="w-4 h-4" />
                  Scan Again
                </Button>
                <Button onClick={handleConfirmScan} className="sm:flex-1 gap-2">
